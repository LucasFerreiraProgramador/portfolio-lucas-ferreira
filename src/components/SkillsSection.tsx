...
const technologies = [
  { 
    ...
    hoverGlow: "hover:shadow-[0_0_30px_rgba(234,88,12,0.5)]"
  },
  { 
    name: "CSS3", 
    icon: (
  ...
  { 
    ...
    hoverGlow: "hover:shadow-[0_0_30px_rgba(250,204,21,0.5)]"
  },
  { 
    name: "React", 
    icon: (
    ...
    hoverGlow: "hover:shadow-[0_0_30px_rgba(34,211,238,0.5)]"
  },
  { 
    name: "Git", 
    icon: (
  ...
  { 
    ...
    hoverGlow: "hover:shadow-[0_0_30px_rgba(156,163,175,0.5)]"
  },
  { 
    name: "TypeScript", 
    icon: (
      <svg viewBox="0 0 128 128" className="w-12 h-12">
        ...
        <path fill="#fff" d="M47.5 68.4v7.1h11.3v39.2h8.5V75.5h11.3v-7.1zm38.1 1.6c-1.5-.2-3-.2-4.4 0-3.1.5-5.9 1.7-8 3.8-2.1 2-3.3 4.7-3.7 7.8-.2 1.6-.1 3.6.3 5.3.8 3.3 2.8 5.8 5.7 7.6 1.7 1.1 3.6 1.9 5.5 2.6 2.6.9 5.1 1.8 7.2 3.4 1 .8 1.8 1.7 2.1 3 .5 1.9.1 3.7-1.2 5.1-1 1.1-2.3 1.6-3.8 1.8-2.3.3-4.4-.2-6.3-1.4-1.5-1-2.5-2.4-3.2-4.1l-7.2 3.8c.6 1.5 1.5 2.9 2.6 4.1 3.3 3.6 7.5 5.1 12.3 5 3.1-.1 6-.8 8.6-2.5 3.5-2.3 5.5-5.5 5.9-9.6.2-2 .1-4-.5-5.9-.9-2.9-2.8-5.1-5.3-6.7-2-1.3-4.2-2.1-6.5-2.9-1.7-.6-3.4-1.2-5-2-1-.5-1.9-1.2-2.4-2.2-.7-1.5-.4-3.1.8-4.2 1-.9 2.2-1.3 3.5-1.3 2.2-.1 3.9.7 5.2 2.5.4.6.8 1.2 1 1.9l6.9-3.3c-.7-1.6-1.7-3-2.9-4.1-2.7-2.5-5.9-3.7-9.7-3.9z"/>
      </svg>
    ),
  ...
  { 
    name: "APIs Rest", 
    icon: (
      <svg viewBox="0 0 24 24" className="w-12 h-12" fill="none" stroke="#00D8FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {technologies.map((tech, index) => (
              <motion.div
                ...
                className={`
                  relative p-6 bg-card rounded-xl border-2 ${tech.borderColor}
                  ${tech.hoverGlow} transition-all duration-300 cursor-pointer
              ...
              >
                ...
                <span className="relative z-10 font-orbitron font-semibold text-foreground text-sm md:text-base">
                  {tech.name}
                </span>
                
                {/* Corner accents */}
                <div className="absolute top-0 left-0 w-3 h-3 border-t-2 border-l-2 border-primary opacity-50 rounded-tl-lg" />
                <div className="absolute top-0 right-0 w-3 h-3 border-t-2 border-r-2 border-primary opacity-50 rounded-tr-lg" />
                <div className="absolute bottom-0 left-0 w-3 h-3 border-b-2 border-l-2 border-primary opacity-50 rounded-bl-lg" />
                <div className="absolute bottom-0 right-0 w-3 h-3 border-b-2 border-r-2 border-primary opacity-50 rounded-br-lg" />
              </motion.div>
            ))}
          </div>
        </motion.div>
